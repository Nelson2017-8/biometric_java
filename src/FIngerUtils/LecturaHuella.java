...
public final class LecturaHuella extends javax.swing.JFrame {
            ...
            try {
                ...
                switch (reclutador.getTemplateStatus()) {
                    case TEMPLATE_STATUS_READY:
                        ...
                        stackTraceElements = Thread.currentThread().getStackTrace();
                        ErrorHandler.log("info", "Plantilla ok!", ErrorHandler.lineCode(stackTraceElements));
                        break;
                    case TEMPLATE_STATUS_FAILED:
                        ...
                        stackTraceElements = Thread.currentThread().getStackTrace();
                        ErrorHandler.log("info", "La plantilla no pudo ser creada!", ErrorHandler.lineCode(stackTraceElements));
                        start();
                        break;
                }
            }
    ...
    private void identificarHuella() throws NoSuchAlgorithmException, KeyManagementException {
        try {
            ...
            for (int i = 0; i < iteracciones; i++) {
                ...
                for (JsonElement jsonElement : list) {
                    ...
                    if (resultado.isVerified()) {
                        ...
                        documento = jsonObject.get("cedula").getAsString();
                        nombre = jsonObject.get("huellaNombre").getAsString();
                        dedo = "Sin especificar";
                        flag = true;
                        break;
                    }
                }
            ...
            if (mensaje.contains("no existe")) {
                ...
                fingerTemp.setEndFingerprint(0);
            } else {
                fingerTemp.setNombre(nombre);
                fingerTemp.setDocumento(documento);
                fingerTemp.setEndFingerprint(1);
                this.stop();
                this.dispose();
            }
    ...
    private finger_temp getFingerTemp() throws NoSuchAlgorithmException, KeyManagementException {
        if (fingerTemp == null) {
