...
public class TrayClass {
    ...
    public static void show() throws IOException {
        ...
        if (trayIcon == null) {
            ...
            MenuItem LogItems = new MenuItem("Archivo log");
            MenuItem close = new MenuItem("Cerrar");

            Addregister.addActionListener((e) -> {
                File f = new File(nameApp);
                String ruta = f.getAbsolutePath();
                String r = CrearServicio.addServicesOnWindows(nameApp, "", ruta);
                if (!r.equals("")) {
            ...
            Deleteregister.addActionListener((e) -> {
                String r = CrearServicio.removeServicesOnWindows(nameApp, "");
                if (!r.equals("")) {
            ...
            LogItems.addActionListener((e) -> {
                //File logFile = new File("src/logs/log.log");
               OpenLog.main();
            });
            menu.addSeparator();
